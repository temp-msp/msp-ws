                        ...
                        <div class="ibox-tools">
                            ...
                            <div class="form-group" id="data_4">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 pull-left">
                                        <select class="form-control m-b" name="semester">
                                    ...
                                    <div class="col-md-3 pull-left">
                                        ...
                                        <button type="button" class="btn btn-w-m btn-success" id="btn-tambah" ><span class="fa fa-plus"></span> Data Baru</button>
...
$(document).ready(function() {
    ...
    function TampilData(data){
        ...
        for(var i=0; i<2; i++)
        {
            ...
            "<button class='btn btn-success btn-xs btn_ubah' type='button' value='"+i+"'>ubah</button>"+
            "<button class='btn btn-danger btn-xs btn_hapus' type='button' value='"+i+"'>hapus</button>";
    ...
    $( "#btn-tambah" ).click(function() {
        var data = -1;
        window.open("<?php echo base_url();?>index.php/KalendarController/KalendarKuliahForm/"+data,"_self"); 
    });

    $('#datatable tbody').on( 'click', '.btn_ubah', function () {
        var data = $(this).attr('value');
        window.open("<?php echo base_url();?>index.php/KalendarController/KalendarKuliahForm/"+data,"_self");       
    });
    $('#datatable tbody').on( 'click', '.btn_detail', function () {
        var data = $(this).attr('value');
        window.open("<?php echo base_url();?>index.php/KalendarController/KalendarKuliahDetail/"+data,"_self");       
    });
